...
//(if you view the project properties for this file, the 'Custom Tool' field should be 'XenFX')
...
//As demonstrated in the Tutorial code, the DrawState object has a generic method 'GetShader'
...
//It will use around 48 static bytes and around 140 bytes for the embedded shader code.
