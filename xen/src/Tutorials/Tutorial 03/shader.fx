...
//This shader is compiled using a visual studio CustomTool plugin, which is installed during prebuild
//(if you view the project properties for this file, the 'Custom Tool' property should be 'XenFX')
...
//Custom tool warning: (16): error X3004: undeclared identifier 'undefinedValue'
//This indicates the custom tool has failed on line 16.
...
//This is the code file generated by the custom tool.
...
//The bottom of this file details some advanced uses for shaders.
