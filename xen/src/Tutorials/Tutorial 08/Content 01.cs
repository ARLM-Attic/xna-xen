...
namespace Tutorials.Tutorial_08
{
	...
	public class Tutorial : Application
	{
		...
		//NEW CODE
		//override the LoadContent method (as declared in IContentOwner, which the Application instance implements)
		...
		protected override void LoadContent(DrawState state, Microsoft.Xna.Framework.Content.ContentManager manager)
		{
			...
			//calling drawToTexture.Warm(DrawState) will force the resource to be created now.
			//
			//The shortcut, drawToTexture.GetTexture(DrawState), will call Warm() if required,
			...
			//A way to test a device reset (in Windows Vista) is to bring up a UAC dialog
		}
