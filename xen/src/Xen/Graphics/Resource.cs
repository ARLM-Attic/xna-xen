...
namespace Xen.Graphics
{
	...
	public enum ResourceUsage : byte
	{
		...
		Dynamic = 1,
		/// <summary>
		/// Equivalent to <see cref="BufferUsage.Points"/>. Only valid on <see cref="IVertices">Vertex Buffers</see>.
		/// </summary>
		Points = 2,
		/// <summary>
	...
	public abstract class Resource
	{
		...
		/// <summary>
		/// Call this to enable resource tracking
		/// </summary>
		...
		{
			lock (this)
				Warm(state.Application,state.graphics);
		}
		/// <summary>
		/// Preload (warm) the resource before its first use
		/// </summary>
