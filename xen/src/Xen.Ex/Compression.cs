...
{
	/// <summary>
	/// Methods to perform *very* simple runlength byte compression (removes runs of repeating bytes). This should only be used to compress large sparse data, it should not be used for compressing runtime data
	/// </summary>
	/// <remarks>
	/// <para>
	/// This class is a simple wrapper on classes embedded in the shader system that perform run length encoding
	/// </para>
	/// <para>This form of compression is only effective at compressing data with a lot of long runs of repeating bytes</para>
	/// </remarks>
	public static class RunLengthEncoding
	{
		...
		{
			return Xen.Graphics.ShaderSystem.Constants.ConstantArray.ArrayUtils.SimpleCompress(source);
		}
		/// <summary>
		/// Decode data
		/// </summary>
		...
		{
			return Xen.Graphics.ShaderSystem.Constants.ConstantArray.ArrayUtils.SimpleDecompress(source);
		}
	}
