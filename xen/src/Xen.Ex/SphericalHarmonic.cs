...
{
	/// <summary>
	/// A structure storing a 9 constant (L2) RGB sperhical harmonic. See remarks for details.
	/// </summary>
	/// <remarks><para>L2 Spherical harmonics are useful for storing approximate lighiting information.</para>
	...
	public struct SphericalHarmonicL2RGB
	{
		...
		public void CopyToGpuArray(Vector4[] l2SphericalHarmonicGpuFormatArray)
		{
			...
			if (l2SphericalHarmonicGpuFormatArray.Length != 9)
				throw new ArgumentException("Input array must be length 9");

			l2SphericalHarmonicGpuFormatArray[0] = new Vector4(SH0, 0);
			l2SphericalHarmonicGpuFormatArray[1] = new Vector4(SH1, 0);
			l2SphericalHarmonicGpuFormatArray[2] = new Vector4(SH2, 0);
			l2SphericalHarmonicGpuFormatArray[3] = new Vector4(SH3, 0);
			l2SphericalHarmonicGpuFormatArray[4] = new Vector4(SH4, 0);
			l2SphericalHarmonicGpuFormatArray[5] = new Vector4(SH5, 0);
			l2SphericalHarmonicGpuFormatArray[6] = new Vector4(SH6, 0);
			l2SphericalHarmonicGpuFormatArray[7] = new Vector4(SH7, 0);
			l2SphericalHarmonicGpuFormatArray[8] = new Vector4(SH8, 0);
		}
