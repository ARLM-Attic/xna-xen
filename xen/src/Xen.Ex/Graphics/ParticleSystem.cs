...
//particle system data, or for hotloading
		...
		//gpu supported?
		internal static readonly bool gpuVTexHalfVec4supported;
		internal static readonly bool gpuVTexVec4supported;
		internal static readonly bool gpuVTexHalfVec2supported;
		internal static readonly bool gpuVTexVec2supported;
		...
		public static bool SystemSupportsGpuParticles
		{
			get
			{
				return gpuVTexHalfVec4supported | gpuVTexVec4supported;
			}
		}
		...
		static ParticleSystem()
		{
			...
			if (adapter.GetCapabilities(DeviceType.Hardware).PixelShaderVersion.Major >= 3)
			{
				gpuVTexVec4supported		= adapter.CheckDeviceFormat(DeviceType.Hardware, SurfaceFormat.Bgr32, TextureUsage.None, QueryUsages.VertexTexture, ResourceType.Texture2D, SurfaceFormat.Vector4);
				gpuVTexHalfVec4supported	= adapter.CheckDeviceFormat(DeviceType.Hardware, SurfaceFormat.Bgr32, TextureUsage.None, QueryUsages.VertexTexture, ResourceType.Texture2D, SurfaceFormat.HalfVector4);
				gpuVTexVec2supported		= adapter.CheckDeviceFormat(DeviceType.Hardware, SurfaceFormat.Bgr32, TextureUsage.None, QueryUsages.VertexTexture, ResourceType.Texture2D, SurfaceFormat.Vector2);
				gpuVTexHalfVec2supported	= adapter.CheckDeviceFormat(DeviceType.Hardware, SurfaceFormat.Bgr32, TextureUsage.None, QueryUsages.VertexTexture, ResourceType.Texture2D, SurfaceFormat.HalfVector2);

				gpuVTexVec4supported		&= Xen.Graphics.DrawTargetTexture2D.SupportsFormat(SurfaceFormat.Vector4);
				gpuVTexHalfVec4supported	&= Xen.Graphics.DrawTargetTexture2D.SupportsFormat(SurfaceFormat.HalfVector4);
				gpuVTexVec2supported		&= Xen.Graphics.DrawTargetTexture2D.SupportsFormat(SurfaceFormat.Vector2);
				gpuVTexHalfVec2supported	&= Xen.Graphics.DrawTargetTexture2D.SupportsFormat(SurfaceFormat.HalfVector2);
			}
		}
	}
